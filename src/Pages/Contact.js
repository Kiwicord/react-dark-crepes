...
const Contact = () => {
    return (
        <div className="contact-content">
            ...
            <div id="trese">
                - Du kannst uns auch eine E-Mail an <a href='contact@kiwicord.com' target="_blank">contact@kiwicord.com</a> senden. Wir bemühen uns, alle E-Mails innerhalb von 24 Stunden zu beantworten.
            </div>
            <div id="quatro">
